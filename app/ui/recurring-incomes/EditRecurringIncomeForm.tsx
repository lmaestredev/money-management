...
import { updateRecurringIncomeAction } from '@/app/lib/actions/recurring-incomes';
...
export default function EditRecurringIncomeForm({ income, accounts, categories }: Props) {
  return (
    <form action={updateRecurringIncomeAction} className={styles.form}>
      ...
      <div className={styles.row}>
        <div className={styles.field}>
          ...
          <input
            ...
            step="0.01"
            className={styles.input}
            defaultValue={income.amount_pesos || undefined}
            placeholder="0"
          />
        </div>
        <div className={styles.field}>
          ...
          <input
            ...
            step="0.01"
            className={styles.input}
            defaultValue={income.amount_dollars || undefined}
            placeholder="0"
          />
        </div>
      </div>
      ...
      <div className={styles.field}>
        ...
        <input
          ...
          step="1"
          className={styles.input}
          defaultValue={income.receive_day ?? undefined}
          placeholder="1"
        />
      </div>
